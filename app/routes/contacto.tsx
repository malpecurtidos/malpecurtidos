...
export default function Contacto() {
  return (
    <div className="bg-[#0f0f0f] min-h-screen">
      ...
      {/* Map Section */}
      <div className="h-[450px] w-full bg-[#1a1a1a] border-t border-white/10 relative grayscale hover:grayscale-0 transition-all duration-700">
        <iframe
        ...
        <div className="absolute inset-0 pointer-events-none bg-gradient-to-t from-[#0f0f0f] to-transparent h-24 mt-auto"></div>
        <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-[#0f0f0f] to-transparent h-24"></div>
      </div>
    </div>
  );
}
