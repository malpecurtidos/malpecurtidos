      ...
      <div className="max-w-[80%] mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="absolute -bottom-10 -right-4 md:-right-10 bg-[#121212]/95 backdrop-blur-md border border-white/10 p-8 rounded-xl shadow-2xl max-w-[280px] md:max-w-[320px] z-20">
              <div className="mb-6">
                <span className="text-[#8B5A2B] text-xs font-bold tracking-[0.2em] uppercase">Stats</span>
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center">
                    <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5 text-[#8B5A2B]" stroke="currentColor" strokeWidth="1.5">
                  ...
                  <div>
                    <div className="text-3xl font-bold text-white mb-0.5">1500+</div>
                    <div className="text-[10px] text-gray-400 uppercase tracking-wider leading-tight">
                      Diseños exclusivos desarrollados
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-3">
                    <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center">
                      <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4 text-[#8B5A2B]" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-white mb-0.5">250+</div>
                      <div className="text-[10px] text-gray-400 uppercase tracking-wider leading-tight">
                        Clientes
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-[#8B5A2B] mb-0.5">10+</div>
                      <div className="text-[10px] text-gray-400 uppercase tracking-wider leading-tight">
                        Reconocimientos
                      </div>
                    </div>
          ...
          <div className="order-1 lg:order-2 space-y-10">
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <div className="w-1 h-8 bg-[#8B5A2B]"></div>
                <span className="text-[#8B5A2B] text-xs md:text-sm font-bold tracking-[0.3em] uppercase">Nuestra Trayectoria</span>
              </div>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                Pasión por la <br />
                <span className="text-[#8B5A2B]">Piel Perfecta</span>
              </h2>
            </div>
            ...
            <div className="pt-4">
              <Link
                to="/productos"
                className="inline-block px-6 py-3 font-bold text-sm md:text-base transition-all duration-300 cursor-pointer rounded-xl shadow-lg bg-[#8B5A2B] text-white hover:bg-[#6B4423] hover:scale-105 hover:shadow-xl hover:shadow-[#8B5A2B]/50 active:scale-100 tracking-wider"
              >
