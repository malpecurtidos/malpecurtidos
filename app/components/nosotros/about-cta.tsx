    ...
    <section className="relative py-24 md:py-32 overflow-hidden bg-[#FAF8F5]">
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="relative bg-[#2A2522] rounded-[2.5rem] p-8 md:p-20 overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] group">
            ...
            <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-radial from-[#8B5A2B]/20 to-transparent opacity-50" />
            ...
            <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center relative z-10">
              <div className="lg:col-span-3 space-y-8">
                <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
                  <span className="relative flex h-2 w-2">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#8B5A2B] opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-[#8B5A2B]"></span>
                  </span>
                ...
                <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white leading-[1.1] tracking-tight">
                  Lleva tu visión <br />
                  <span className="text-[#8B5A2B]">al siguiente nivel</span>
                </h2>
                ...
                <div className="flex flex-wrap gap-5 pt-4">
                  <Button 
                    variant="primary" 
                    className="bg-[#8B5A2B] hover:bg-[#A67C52] text-white px-8 md:px-10 py-7 rounded-2xl text-base md:text-lg font-bold transition-all duration-500 shadow-xl shadow-[#8B5A2B]/20 hover:shadow-[#8B5A2B]/40 hover:-translate-y-1"
                  >
                    Contáctanos
                  </Button>
                  <Link to="/productos">
              ...
              <div className="lg:col-span-2 relative hidden md:block">
                <div className="aspect-square relative flex items-center justify-center">
                  {/* Anillos orbitales */}
                  <div className="absolute inset-0 border border-[#8B5A2B]/20 rounded-full animate-[spin_30s_linear_infinite]" />
                  <div className="absolute inset-8 border border-white/5 rounded-full animate-[spin_20s_linear_infinite_reverse]" />
                  <div className="absolute inset-16 border border-[#8B5A2B]/10 rounded-full animate-[spin_25s_linear_infinite]" />
                  ...
                  <div className="relative w-64 h-80 bg-[#4A2D14] rounded-[2rem] shadow-2xl flex items-center justify-center transform group-hover:scale-105 transition-all duration-700 ease-out overflow-hidden">
                    ...
                    {/* Etiqueta flotante */}
                    <div className="absolute top-8 right-0 bg-[#D4AF37] px-3 py-1 -rotate-90 origin-right translate-x-2">
                      <span className="text-[10px] font-bold text-[#2A2522] uppercase tracking-tighter">Premium Grade</span>
                    </div>
                  </div>
                  ...
                  <div className="absolute top-10 right-0 bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/10 shadow-xl -rotate-12 translate-x-10 group-hover:translate-x-4 transition-transform duration-700">
                    <div className="w-8 h-8 rounded-full bg-[#8B5A2B]/20 flex items-center justify-center mb-2">
