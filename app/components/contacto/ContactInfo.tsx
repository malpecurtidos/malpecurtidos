    ...
    <div className="bg-[#1a1a1a] border border-white/5 rounded-2xl p-8 shadow-2xl">
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-start gap-4 group">
          <div className="p-3 rounded-xl bg-[#D4AF37]/10 text-[#D4AF37] group-hover:bg-[#D4AF37] group-hover:text-[#1a1a1a] transition-all duration-300">
        ...
        <div className="flex items-start gap-4 group">
          ...
          <div>
            ...
            <a href="tel:+524777785045" className="text-gray-400 hover:text-[#D4AF37] transition-colors font-light">
              +52 (477) 778 5045
            </a>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 group">
          ...
          <div>
            ...
            <a href="mailto:ventas@malpe.com.mx" className="text-gray-400 hover:text-[#D4AF37] transition-colors font-light">
              ventas@malpe.com.mx
            </a>
          </div>
        </div>
